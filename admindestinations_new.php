...
<body>
    ...
    <div class="menu">
        ...
        <h2>Regjsitrimi i Destinacionit te ri</h2>
        <div id="add-destination-form">
        <form id="destinationForm" action="exec/adddestination.php" method="POST">
            <div style="margin-bottom: 15px;">
                <label for="destinationName">Destinacioni:</label><br>
                <input type="text" id="destinationName" name="destinationName" required style="width: 100%; padding: 8px; border: 1px solid #ddd; border-radius: 4px;">
            </div>
            <div style="margin-bottom: 15px;">
        ...
        <div style="margin-bottom: 15px;">
                ...
                <input type="text" id="iata" name="iata" required style="width: 100%; padding: 8px; border: 1px solid #ddd; border-radius: 4px;">
            </div>
            <div style="margin-bottom: 15px;">
    ...
    <select id="stateid" name="stateid" required style="width: 100%; padding: 8px;">
        ...
        ?>
            ...
            <button type="submit" class="add-btn">
                <i class="fa fa-save"></i> Shto Destinacionin
            </button>
