...
<head>
    ...
    <title>SlopeTravel - Regjistrimi i Fluturimit të Ri</title>
...
<body>
    ...
    <div class="menu">
        ...
        <div class="form-container" id="form-container">
            <h2>Regjistrimi i Fluturimit të Ri</h2>
            <form action="exec/addnewflight.php" method="POST">
                <div>
                ...
                <div>
                    ...
                    <select id="airlineid" name="airlineid" required>
                        <option value="" disabled selected>Zgjidh Linjën Ajrore</option>
                        <?php
                ...
                <div>
                    ...
                    <input type="time" id="departureflighttime" name="departureflighttime" required>
                </div>
                <div>
                ...
                <div>
                    ...
                    <input type="time" id="arrivalflighttime" name="arrivalflighttime" required>
                </div>
                <div>
                ...
                <div>
                    ...
                    <input type="text" id="flightlink" name="flightlink" required>
                </div>
