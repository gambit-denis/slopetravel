...
<head>
    ...
    <title>SlopeTravel - Regjistrimi i Aeroportit te Ri</title>
...
<body>
    ...
    <div class="menu">
        ...
        <div class="form-container" id="form-container">
            <h2>Regjistrimi i Aeroportit te Ri</h2>
            <form action="exec/addnewairport.php" method="POST">
                <div>
                ...
                <div>
                    ...
                    <input type="text" id="iata" name="iata" required maxlength="4">
                </div>
                <div>
